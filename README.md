...
- 👥 **Patient Search & Management** - Search and filter patients by clinician, date, and name
- 📊 **Interactive Reports** - Comprehensive patient profiles with visual data presentations
- 🧠 **AI Clinical Insights** - Action items and potential diagnoses generated by GPT-5
- 📈 **Scale Visualizations** - Radar charts and score breakdowns for psychological assessments
- 📄 **PDF Export** - Generate and download formatted assessment reports
- 💭 **Sentiment Analysis** - View emotional tone analysis of patient narratives
- 📝 **Treatment Planning** - AI-assisted treatment recommendations
- 🎙️ **Audio Playback** - Listen to patient voice recordings with transcriptions
...
│  ├────────────────────────────────────────────────────────────────────┤ │
│  │                                                                     │ │
│  │  /search         ─────────────────── Patient search & list         │ │
│  │  /report/[patientId]  ────────────── Patient report layout         │ │
│  │    ├── /           ─────────────── Overview (At a Glance)          │ │
│  │    ├── /scales     ─────────────── Assessment scale scores         │ │
│  │    ├── /journals   ─────────────── Patient mood journals           │ │
│  │    ├── /treatment-plan ─────────── AI insights & diagnoses         │ │
│  │    └── /learn      ─────────────── Psychoeducation progress        │ │
│  │  /analysis         ─────────────── Batch analysis tools            │ │
│  │                                                                     │ │
│  └────────────────────────────────────────────────────────────────────┘ │
│                                                                          │
│  ┌────────────────────────────────────────────────────────────────────┐ │
...
│  │                                                                     │ │
│  │  Report/                                                           │ │
│  │  ├── PatientReportClient.tsx  ─── Main report view                 │ │
│  │  ├── ReportHeader.tsx         ─── Patient header with actions      │ │
│  │  ├── TopBlocks.tsx            ─── Summary blocks grid              │ │
│  │  ├── Cards.tsx                ─── Data display cards               │ │
│  │  ├── DetailPanels.tsx         ─── Expandable detail panels         │ │
│  │  ├── RadarChart.tsx           ─── Scale score visualization        │ │
│  │  └── ui.tsx                   ─── Shared UI components             │ │
│  │                                                                     │ │
│  │  ScaleDetailDrawer.tsx        ─── Scale breakdown drawer           │ │
│  │  AssessmentReportPDFAdult.tsx ─── PDF generation (adult)           │ │
│  │  AssessmentReportPDFChild.tsx ─── PDF generation (child)           │ │
│  │  Garden/                      ─── Wellness visualization           │ │
│  │  WeatherWidget.tsx            ─── Mood weather display             │ │
│  │                                                                     │ │
│  └────────────────────────────────────────────────────────────────────┘ │
│                                                                          │
│  ┌────────────────────────────────────────────────────────────────────┐ │
...
│  ├────────────────────────────────────────────────────────────────────┤ │
│  │                                                                     │ │
│  │  /api/clinician/patients      ─── List patients for clinician      │ │
│  │  /api/clinician/patients/[id] ─── Get specific patient profile     │ │
│  │  /api/clinician/scales        ─── Get assessment scale data        │ │
│  │  /api/clinician/insights      ─── Trigger/fetch AI insights        │ │
│  │  /api/clinician/journal       ─── Get patient journal entries      │ │
│  │  /api/sentiment               ─── Trigger sentiment analysis       │ │
│  │  /api/summarize               ─── Trigger profile summarization    │ │
│  │  /api/transcribe              ─── Trigger audio transcription      │ │
│  │  /api/pdf/download            ─── Generate PDF report              │ │
│  │  /api/audio                   ─── Stream audio files               │ │
│  │                                                                     │ │
│  └────────────────────────────────────────────────────────────────────┘ │
│                                                                          │
└─────────────────────────────────────────────────────────────────────────┘
              ...
              │                                       │
              │  Cloud SQL (MySQL)                    │
              │  └── Shared database with intake-v2   │
              │                                       │
              └───────────────────────────────────────┘
```
...
│   │   │   │   │   ├── route.ts      # GET /api/clinician/patients
│   │   │   │   │   ├── [id]/         # Single patient
│   │   │   │   │   └── search/       # Patient search
│   │   │   │   ├── scales/           # Assessment scales
│   │   │   │   │   ├── route.ts      # GET scales for patient
│   │   │   │   │   └── assign/       # Assign scales to patient
│   │   │   │   ├── insights/         # AI clinical insights
│   │   │   │   │   └── route.ts      # Fetch action items & diagnoses
│   │   │   │   └── journal/          # Patient journal entries
│   │   │   │
│   │   │   ├── sentiment/            # Sentiment analysis trigger
│   │   │   ├── summarize/            # Profile summarization
│   │   │   ├── transcribe/           # Transcription trigger
│   │   │   ├── audio/                # Audio file streaming
│   │   │   ├── pdf/                  # PDF generation
│   │   │   │   └── download/         # PDF download endpoint
│   │   │   └── weather/              # Mood weather data
│   │   │
│   │   ├── search/                   # Patient search page
│   │   │   └── page.tsx              # Clinician home/search
│   │   │
│   │   ├── report/                   # Patient report pages
│   │   │   └── [patientId]/          # Dynamic patient routes
│   │   │       ├── layout.tsx        # Report sidebar layout
│   │   │       ├── page.tsx          # Overview page
│   │   │       ├── scales/           # Scales page
│   │   │       │   └── page.tsx
│   │   │       ├── journals/         # Journals page
│   │   │       │   └── page.tsx
│   │   │       ├── treatment-plan/   # Treatment plan page
│   │   │       │   └── page.tsx
│   │   │       └── learn/            # Psychoeducation page
│   │   │           └── page.tsx
│   │   │
│   │   ├── analysis/                 # Batch analysis tools
│   │   │   └── page.tsx
...
│   │   │   │   ├── PatientReportClient.tsx  # Main report view
│   │   │   │   ├── ReportHeader.tsx         # Header with actions
│   │   │   │   ├── PatientTopBar.tsx        # Patient info bar
│   │   │   │   ├── TopBlocks.tsx            # Summary blocks
│   │   │   │   ├── Cards.tsx                # Data cards
│   │   │   │   ├── DetailPanels.tsx         # Expandable panels
│   │   │   │   ├── RadarChart.tsx           # Scale visualization
│   │   │   │   └── ui.tsx                   # Shared UI elements
│   │   │   │
│   │   │   ├── AssessmentReportPDFAdult.tsx # Adult PDF template
│   │   │   ├── AssessmentReportPDFChild.tsx # Child PDF template
│   │   │   ├── ScaleDetailDrawer.tsx        # Scale breakdown
│   │   │   ├── Drawer.tsx                   # Slide-out panel
│   │   │   ├── WeatherWidget.tsx            # Mood display
...
│   │   │   ├── cloudrun-client.ts    # Cloud Run API client
